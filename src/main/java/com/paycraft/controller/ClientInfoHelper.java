    ...
    */
    ...
    public Response doLog(ClientsInfoObj  obj) throws ServiceException, Exception
    {
        ...
        try 
        {
            ...
            ClientsInfo trxLog = getByCredzOr(obj.clientName, obj.partnerID);
            if(trxLog ==null)
            {
               ...
               if(obj.tokenExpiryDays> 0)
               {
                  newobj.setTokenLifespanDays(obj.tokenExpiryDays);
               }
               else
               {
    ...
    public Response doSyncClient(ClientsInfoObj  obj) throws ServiceException, Exception
    {
        ...
        try 
        {
            ...
            {
                trxLog =  getByName(obj.clientName);
            }
            
            if(trxLog != null)
            {
                ClientsInfo byName = getByName(obj.clientName);
